...
<tbody>
<tr>
<td>- 전체 업무 페이지 / 프로젝트의 피드 업무,하위업무 상세 정보 표출 및 수정 기능<br>- 캘린더 페이지 / 프로젝트 및 피드 일정 표출 및 개인 일정 등록 기능<br>- 게시판 페이지 / 게시글 및 댓글 작성,수정,삭제 기능<br>- 소모임 정보 목록 조회 / 상세 조회 <br>- 클래스 다이어그램<br>- 프로젝트 SQL DB 취합</td>
